...
public class SendEmail extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPreExecute() {
        ...
        progressDialog = ProgressDialog.show(context,"Message en cours d'envoie","Veuillez patienter...",false,false);
    }
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        Toast.makeText(context,"Votre message a bien étét envoyé.",Toast.LENGTH_LONG).show();
    }
